...
<b>Bot Maintained By: @BotDunia</b> \n
<b>/help for more details</b> \n
"""

    RENAME_403_ERR = "What Are You Doing? Bruuh!!\nYou can't do that"
    BANNED_USER_TEXT = "Sorry!! But @Mrvishal_bot Owner Has Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @Mrvishal_2k2 For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "It's a free service!! If you are rich Then donate by asking donation method from\n@Mrvishal_2k2 "
    DOWNLOAD_START = "<b>Downloading To My server 📥</b>"
    UPLOAD_START = "<b>Uploading To Telegram 📤</b>"
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry WTF Do You Think! I'll Upload It?\n Never Telegram limitation is 1.95gb"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin > @BotDunia  ❤️**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @Mrvishal_bot "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @BotDunia "
    ...
    CUSTOM_CAPTION_UL_FILE = "By @Mixxrenamebot"
